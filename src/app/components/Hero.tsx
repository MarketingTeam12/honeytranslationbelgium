    ...
    <section className="relative pt-40 pb-32 px-6 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto text-center">
        ...
        <p className="text-lg text-[rgba(239,237,253,0.7)] mb-12 max-w-2xl mx-auto">
          Premium translation services for Belgium. Expert linguists, certified workflows and local SEO-ready language support for Brussels, Antwerp, Ghent and Liege.
        </p>
